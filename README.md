...
2. Командой git clone создаем нашу версию данного репозитория
3. Создаем ветку с предлагаемыми изменениями 
4. Производим все изменения исключительно в этой ветке
5. Отправляем с помощью команды git push эти изменения на свой аккаунт 
6. После проделанных действий на гитхаб появится возможность запросить разрешение на внесение изменений в проект
