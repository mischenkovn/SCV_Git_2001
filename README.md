...
```
Переключение на новую ветку в таком случае соответствующей соответственно командой:
```
...
```
Коданда вызывается соответственно из той ветки, в которую необходимо перенести изменения. 
...
Если в Pull Request больше нет необходимости, во вкладке `Pull Requests` его можно закрыть, нажав `Close`. При желании можно также удалить вашу ветку или созданный fork.