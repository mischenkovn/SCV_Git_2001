...
Параметр `--amend` позволяет объединить проиндексированные изменения с предыдущим коммитом без создания нового коммита. **_Не используйте amend для публичных коммитов!!!_**
