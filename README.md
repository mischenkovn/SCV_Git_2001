...
Для создания новой отрекдактированной версии проектов (для создания коммита) во всех ранее добавленных к отслеживанию файлах используется команда:
```
git commit -а -m "comment"
```
