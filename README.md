...
Перед тем как склонировать с гитхаба, в VS Code надо сделать команду
cd..  что бы выйти из той папки ,  в которой работали, и попасть в родительский каталог что бы создалась новая клонированая папка, например  просто на диске Е.
Но если надо что бы сохранилась в определенной папке, тогда надо в нее зайти на компе, что бы там сохранился клон.
