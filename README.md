...
## Установка Git
Загружаем последнюю версию Git с [официального сайта](https://git-scm.com/downloads) и устанавливаем с настройками "по умолчанию".
## Установка Visual Studio Code
Загружаем последнюю версию VS Code с [официального сайта](https://code.visualstudio.com/download) и устанавливаем с настройками "по-умолчанию".
## Настройка Git
...
```
git checkout <уникальный хеш коммита>
```
...
Ветка в Git - простой перемещаемый указатель на один из коммитов, обычно последний в цепочке коммитов. По умолчанию, имя овновной ветки в Git - `master`.  Создать ветку можно коммандой:
```
...
```
Для отображения истории коммитов в формате дерева веток используйте:
```
git log -- graph
```
