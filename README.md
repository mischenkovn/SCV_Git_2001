...
Для создания тега используйте git tag -a <tag name> -m "tag_commit"

Для просмотра уже созданного ранее тега используйте git show <tag name>

Для удаления тега используйте git tag -d <tag name>

Для выгрузки в удаленный репозиторий всех созданных тегов используйте git push --tags
