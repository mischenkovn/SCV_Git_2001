...
Если просто ввести команду git commit, то версия тоже сохранится, но откроется встроенный в git редактор vim.
Для того, чтобы выйти из него и ничего не сломать нажмите esc, а затем наберите :x (выход с сохранением).
