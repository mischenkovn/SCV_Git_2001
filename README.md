...
```
Также для дальнейшего удобства, мы можем использовать эту команду с дополнительым ключем -а (он заменит команду `git add`, которую необходимо вводить после каждого изменения в файл до коммита). *Но важно помнить, что команду в таком виде можно использовать только в том случае, если уже хотя бы один раз вводили команду `git add`*
```
